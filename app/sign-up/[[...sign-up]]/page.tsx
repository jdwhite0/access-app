...
export const metadata = {
  title: 'Create your account — JYSON by JD AI Systems',
}
          ...
          <div className="access-auth-brand">
            <div className="access-auth-brand__inner">
              ...
              <div className="access-auth-brand__pillars">
                {[
                  { icon: '◈', label: 'Free to start',   desc: 'No credit card required. Your operator is live the moment you sign up.' },
                  { icon: '◎', label: 'Your JYSON',      desc: 'AI intelligence that learns your context and compounds every session.' },
                  { icon: '▤', label: 'Your workspace',  desc: 'Projects, systems, assets, and offers — all in one place.' },
                ].map((p) => (
            ...
            <div className="access-auth-form__inner">
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <p style={{ fontSize: 15, color: '#697386', margin: 0, lineHeight: 1.6 }}>
                  Free forever. Your AI operator is waiting.
                </p>
              </div>

              {/* Legal consent — inline, no boxes */}
              <SignUpAgeGate />
              ...
              <div style={{ marginTop: 28, paddingTop: 24, borderTop: '1px solid #f0f4f8', textAlign: 'center' }}>
                <p style={{ fontSize: 14, color: '#697386', margin: '0 0 16px' }}>
                  ...
                  <Link href="/sign-in" style={{ color: '#0a2540', fontWeight: 600, textDecoration: 'none' }}>
                    Sign in
                  </Link>
                </p>
