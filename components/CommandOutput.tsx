  ...
  switch (command) {
    ...
    case '/help': {
      const sections: Array<{ heading?: string; cmd?: string; desc?: string }> = [
        ...
        { heading: 'Navigation' },
        { cmd: '/founder',                   desc: 'Open Founder Blueprint wizard (full-page)' },
        { cmd: '/companion',                 desc: 'Open JYSON Companion inside ACCESS' },
        { cmd: '/connect-jyson',             desc: 'How JYSON connects to your ACCESS handle' },
        { heading: 'Ecosystem' },
