...
export function resolvePrimaryNavId(pathname: string): PrimaryNavId | null {
  ...
  if (pathname.startsWith('/companion')) return 'intelligence'
  if (pathname.startsWith('/agents')) return 'team'
  if (pathname.startsWith('/memory')) return 'knowledge'
  if (pathname.startsWith('/offers')) return 'offers'
  if (pathname.startsWith('/registry')) return 'assets'
  if (pathname.startsWith('/assets')) return 'assets'
  if (pathname.startsWith('/systems')) return 'systems'
  if (pathname.startsWith('/blueprints')) return 'systems'
  if (pathname.startsWith('/workflows')) return 'systems'
  if (pathname.startsWith('/vaults')) return 'assets'
  if (pathname.startsWith('/customers')) return 'customers'
  if (pathname.startsWith('/admin')) return 'admin'
  if (pathname.startsWith('/settings/billing')) return 'platform'
  if (pathname.startsWith('/settings')) return 'platform'
  if (pathname.startsWith('/plans')) return 'platform'
  if (pathname.startsWith('/founder')) return null
  if (pathname.startsWith('/internal')) return 'admin'
  if (pathname.startsWith('/status')) return 'platform'
